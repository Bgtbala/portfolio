    ...
    return (
        <div className="fixed inset-0 pointer-events-none z-50 flex flex-col justify-between p-8 font-mono">
            ...
            <div className="flex justify-between items-end">
                {/* Speedometer */}
                <div className="bg-black/60 backdrop-blur-md border border-white/20 p-6 rounded-2xl text-white min-w-[200px]">
                    <div className="flex justify-between items-center mb-2">
                        ...
                        {nitroActive && (
                            <motion.div
                                ...
                                className="flex items-center gap-1 text-cyan-400 text-[10px] font-black"
                            >
                    ...
                    <div className="flex items-baseline gap-2">
                        <span className="text-6xl font-black italic tracking-tighter">{speed}</span>
                        <span className="text-xl font-bold text-white/30 italic">KM/H</span>
                    </div>
                </div>

                {/* Score / Drifts */}
                <div className="bg-black/60 backdrop-blur-md border border-white/20 p-6 rounded-2xl text-white text-right h-fit mb-4">
                    <div className="flex items-center justify-end gap-2 mb-1">
                        <Trophy className="w-4 h-4 text-yellow-500" />
                        <span className="text-[10px] uppercase tracking-widest text-white/50">Drift Score</span>
                    </div>
                    <div className="text-4xl font-black">{driftScore.toLocaleString()}</div>
                </div>
            </div>


            {/* Controls Info */}
            <div className="fixed bottom-32 left-1/2 -translate-x-1/2 flex gap-4 text-white/40 text-[10px] tracking-[0.2em] font-bold">
